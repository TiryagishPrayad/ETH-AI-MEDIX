...
DEPLOYED_ADDRESS = "https://ethaimedix.netlify.app"  # Changed here
...
def predict_disease():
    ...
    ['decision_treecle_weakness', 'stiff_neck', 'swelling_joints',
      'movement_stiffness', 'spinning_movements', 'loss_of_balance', 'unsteadiness',
      'weakness_of_one_body_side', 'loss_of_smell', 'bladder_discomfort', 'foul_smell_of urine',
      'continuous_feel_of_urine', 'passage_of_gases', 'internal_itching', 'toxic_look_(typhos)',
      'depression', 'irritability', 'muscle_pain', 'altered_sensorium', 'red_spots_over_body', 'belly_pain',
...
def predict_disease():
    ...
    # Sending request to the deployed address
    deployed_url = "https://ethaimedix.netlify.app" 
    response = requests.post(deployed_url, json=data)
    ...
    return jsonify({
        ...
        'response_from_deployed_address': response_data
    })
